            ...
            <div class="app-content">
                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-header">
                        <div class="card-title">Добавление пункта в расписание</div>
                    </div>
                    <!--end::Header-->
                    <!--begin::Form-->
                    <form action="{{ route('schedule.update', $schedule->id)}}" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label for="hour" class="form-label">Часы</label>
                                <input type="number" name="hour" class="form-control @error('hour') is-invalid @enderror" value="{{ $schedule->hour }}" id="hour" aria-describedby="emailHelp">
                                <label for="minute" class="form-label">Минуты</label>
                                <input type="number" name="minute" class="form-control @error('minute') is-invalid @enderror" value="{{ $schedule->minute }}" id="minute" aria-describedby="emailHelp">
                                <div id="emailHelp" class="form-text">
                                    Введите заголовок
                                </div>
                            </div>
                            <div class="input-group mb-3">
                                <label class="input-group-text" for="section">Секция</label>
                                <input type="text" value="{{ $schedule->section }}" class="form-control @error('section') is-invalid @enderror" id="section" name="section">
                            </div>
                            <div class="input-group mb-3">
                                <label class="input-group-text" for="price">Цена</label>
                                <input type="number" value="{{ $schedule->price }}" class="form-control @error('price') is-invalid @enderror" id="price" name="price">
                            </div>
                        </div>
                        <!--end::Body-->
                        <!--begin::Footer-->
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary">Сохранить пункт в расписание</button>
                        </div>
                        <!--end::Footer-->
                    </form>
                    <!--end::Form-->
