                    ...
                    <form action="{{ route('schedule.store')}}" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="hour" class="form-control @error('hour') is-invalid @enderror" id="hour" aria-describedby="emailHelp">
                                <label for="minute" class="form-label">Минуты</label>
                                <input type="number" name="minute" class="form-control @error('minute') is-invalid @enderror" id="minute" aria-describedby="emailHelp">
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary">Добавить пункт в расписание</button>
                        </div>
                        <!--end::Footer-->
                    </form>
                    <!--end::Form-->
