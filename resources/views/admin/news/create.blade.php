            ...
            <div class="app-content">
                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-header">
                        <div class="card-title">Создание новости</div>
                    </div>
                    <!--end::Header-->
                    <!--begin::Form-->
                    <form action="{{ route('news.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('text') is-invalid @enderror" name="text" aria-label="With textarea"></textarea>
                            </div>
                            ...
                            <div class="input-group mb-3">
                                <input type="file" class="form-control @error('image') is-invalid @enderror" id="image" name="big_image">
