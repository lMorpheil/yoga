            ...
            <div class="app-content">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Редактировать новости</h3>
                    </div>
                    <div class="app-content">
                        <!--begin::Container-->
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered">
                                        ...
                                        @if(count($news))
                                            @foreach($news as $key => $new)
                                                <tr>
                                                    ...
                                                    <td>{{ $new->title }}</td>
                                                    <td>
                                                        <a class="btn btn-info" href="{{ route('news.edit', $new->id) }}" style=""><i class="bi bi-pen-fill"></i></a>
                                        ...
                                        @else
                                            <tr>
                                                <td colspan="3">Пока нет ни одной новости</td>
                                            </tr>
                                        @endif
...
{{--                                    </ul>--}}
                ...
                <a class="btn btn-primary" href="{{ route('news.create') }}" style="margin-top:10px">Добавить Новость</a>
            </div>
            <!--end::App Content-->
        </main>
        <!--end::App Main-->
