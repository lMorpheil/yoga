            ...
            <div class="app-content">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Редактировать карточку преподавателя</h3>
                    </div>
                    <div class="app-content">
                        <!--begin::Container-->
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered">
                                        ...
                                        @if(count($employees))
                                            @foreach($employees as $key => $employee)
                                                <tr>
                                                    ...
                                                    <td>{{ $employee->name }}</td>
                                                    <td>
                                                        <a class="btn btn-info" href="{{ route('employees.edit', $employee->id) }}" style=""><i class="bi bi-pen-fill"></i></a>
                                                        <form action="{{ route('employees.destroy', $employee->id) }}" method="post" style="display: inline">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button class="btn btn-danger" type="submit" onclick="return confirm('Точно хотите удалить преподавателя?')"><i class="bi bi-trash3-fill"></i></button>
                                                        </form>
                                        ...
                                        @else
                                            <tr>
                                                <td colspan="3">Пока нет сотрудников</td>
                                            </tr>
                                        @endif
...
{{--                                    </ul>--}}
                ...
                <a class="btn btn-primary" href="{{ route('employees.create') }}" style="margin-top:10px">Добавить преподавателя</a>
            </div>
            <!--end::App Content-->
        </main>
        <!--end::App Main-->
