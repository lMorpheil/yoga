            ...
            <div class="app-content">
                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-header">
                        <div class="card-title">Добавление сотрудника</div>
                    </div>
                    <!--end::Header-->
                    <!--begin::Form-->
                    <form action="{{ route('employees.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="profession" class="form-control @error('profession') is-invalid @enderror" id="profession" aria-describedby="emailHelp">
                            </div>
                            <div class="mb-3">
                                <label for="age_years" class="form-label">Год рождения</label>
                                <input type="text" name="age_years" class="form-control @error('age_years') is-invalid @enderror" id="age_years" aria-describedby="emailHelp">
                            </div>
                            <div class="input-group mb-3">
                                <input type="file" class="form-control @error('previews') is-invalid @enderror" id="previews" name="previews">
                                <label class="input-group-text" for="previews">Загрузить фото для главной страницы</label>
                            </div>
                            <div class="input-group mb-3">
                                <input type="file" class="form-control @error('img_modal') is-invalid @enderror" id="img_modal" name="img_modal">
                                <label class="input-group-text" for="img_modal">Загрузить фото для модального откна</label>
                            </div>
                        </div>
                        <!--end::Body-->
                        <!--begin::Footer-->
