            ...
            <div class="app-content">
                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-header">
                        <div class="card-title">Редактирование новости</div>
                    </div>
                    <!--end::Header-->
                    <!--begin::Form-->
                    ...
                    <form action="{{ route('news.update', $new->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" id="title" aria-describedby="emailHelp" value="{{ $new->title }}">
                                <div id="emailHelp" class="form-text">
                                    Введите заголовок
                                </div>
                            </div>
                            <div class="mb-3">
                                <span class="input-group-text">Текст новости</span>
                                <textarea class="form-control @error('text') is-invalid @enderror" name="text" aria-label="With textarea">{{ $new->text }}</textarea>
                            </div>
                            <div class="input-group mb-3">
                                <input type="file" class="form-control @error('image') is-invalid @enderror" id="image" name="image" value="{{ $new->image }}">
                                <label class="input-group-text" for="image">Загрузить тизер</label>
                            </div>
                            <div class="input-group mb-3">
                                <input type="file" class="form-control @error('image') is-invalid @enderror" id="image" name="big_image" value="{{ $new->big_image }}">
                                <label class="input-group-text" for="image">Загрузить изображение</label>
                            </div>
                        </div>
                        <!--end::Body-->
                        <!--begin::Footer-->
