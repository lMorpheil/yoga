                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('actions.index') }}" class="nav-link active">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Акции</p>
                                    </a>
                                </li>
            ...
            <div class="app-content">
                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-header">
                        <div class="card-title">Редактирование акции</div>
                    </div>
                    <!--end::Header-->
                    <!--begin::Form-->

                    <form action="{{ route('actions.update', $actions->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <!--begin::Body-->
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('text') is-invalid @enderror" name="text" aria-label="With textarea">{{ $actions->text }}</textarea>
                            </div>
                            <div class="input-group mb-3">
                                <input type="file" class="form-control @error('image') is-invalid @enderror" id="image" name="image" value="{{ $actions->image }}">
