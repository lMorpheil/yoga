            ...
            <div class="app-content">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Редактировать акции</h3>
                    </div>
                    <div class="app-content">
                        <!--begin::Container-->
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered">
                                        ...
                                        @if(count($actions))
                                            @foreach($actions as $key => $action)
                                                <tr>
                                                    ...
                                                    <td>{{ $action->text }}</td>
                                                    <td>
                                                        <a class="btn btn-info" href="{{ route('actions.edit', $action->id) }}" style=""><i class="bi bi-pen-fill"></i></a>
                                                        <form action="{{ route('actions.destroy', $action->id) }}" method="post" style="display: inline">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button class="btn btn-danger" type="submit" onclick="return confirm('Точно хотите удалить акцию?')"><i class="bi bi-trash3-fill"></i></button>
                                                        </form>
                                        ...
                                        @else
                                            <tr>
                                                <td colspan="3">Пока нет ни одной акции</td>
                                            </tr>
                                        @endif
...
{{--                                    </ul>--}}
                ...
                <a class="btn btn-primary" href="{{ route('actions.create') }}" style="margin-top:10px">Добавить акцию</a>
            </div>
            <!--end::App Content-->
        </main>
        <!--end::App Main-->
